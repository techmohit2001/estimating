...
const PROCESS_STEPS = [
  {
    ...
    description:
      'We review your electrical drawings, specifications, panel schedules, lighting plans, power layouts, and project scope.',
  ...
  },
  {
    ...
    description:
      'Our team identifies all electrical items, including lighting, wiring, conduits, panels, switches, outlets, fixtures, devices, and low-voltage systems.',
  ...
  },
  {
    ...
    description:
      'We measure and count all required electrical materials from the drawings to prepare an accurate electrical quantity takeoff.',
  ...
  },
  {
    ...
    description:
      'We prepare a clear breakdown of material costs, labor costs, equipment costs, fixtures, panels, wiring, and complete electrical scope items.',
  ...
  },
  {
    ...
    description:
      'After quality checking, we deliver a clean electrical estimate ready for bidding, budgeting, procurement, and project planning.',
