...
export default function Hero() {
  return (
    <section className="relative w-full overflow-hidden bg-black min-h-[380px] h-[58vh] sm:min-h-[500px] sm:h-[min(80vh,720px)]">
      <div
        className="absolute inset-0 [clip-path:polygon(72%_0,100%_0,100%_100%,58%_100%)] sm:[clip-path:polygon(58%_0,100%_0,100%_100%,42%_100%)]"
        aria-hidden
      >
        <Image
          src="/services-electrical-services.png"
          alt="Electrical professionals reviewing blueprints on site"
          fill
          priority
          className="scale-110 object-cover object-[44%_38%] sm:object-[40%_34%] lg:object-[36%_30%]"
          sizes="(max-width: 640px) 45vw, 55vw"
        />
      </div>
      ...
      <div className="relative z-10 mx-auto flex h-full w-full max-w-[1400px] items-center px-4 sm:px-10 lg:px-16">
        <div className="max-w-[240px] ml-3 mt-6 sm:max-w-[520px] sm:ml-14 sm:mt-14 lg:ml-20 lg:mt-16 lg:max-w-[720px]">
          ...
          >
            <span className="text-[#2997FF]">Electrical</span>
            <br />
          ...
          <p
            ...
            style={{ fontFamily: 'Poppins, sans-serif' }}
          >
            Save time before bid day with precise electrical cost estimating services.
          </p>
        </div>
      </div>
    </section>
