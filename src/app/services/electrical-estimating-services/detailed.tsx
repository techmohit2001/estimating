...
export default function Detailed() {
  return (
    <div className="w-full pt-2 pb-8 lg:pt-3 lg:pb-10">
      ...
      >
        Get a Bid-Ready Electrical Estimate
      </h2>
      ...
      <div className="mt-8 grid grid-cols-1 items-center gap-8 lg:grid-cols-2 lg:gap-10 xl:gap-12">
        <p
          ...
          style={bodyTextStyle}
        >
          If you need accurate and organized electrical estimating services, send us your
          electrical drawings and scope documents. We will review your files and prepare a clear
          estimate that supports bidding, budgeting, procurement, and project planning. Our
          electrical takeoff services help contractors, builders, developers, architects,
          engineers, and project owners make better cost decisions before work begins. From
          lighting and power systems to panels, conduit, wiring, switchgear, grounding, and
          low-voltage scope, we help turn electrical drawings into usable estimating data.
        </p>
