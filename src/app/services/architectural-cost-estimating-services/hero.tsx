...
export default function Hero() {
  return (
    <section className="relative w-full overflow-hidden min-h-[420px] h-[62vh] sm:min-h-[520px] sm:h-[min(82vh,720px)]">
      <Image
        src="/services-cost-services.png"
        alt="Architectural cost estimating services"
        fill
        priority
      ...
      <div
        className="absolute inset-0 [clip-path:polygon(72%_0,100%_0,100%_100%,58%_100%)] sm:[clip-path:polygon(58%_0,100%_0,100%_100%,42%_100%)] bg-[linear-gradient(to_left,rgba(0,0,0,0.42)_0%,rgba(0,0,0,0.18)_32%,transparent_62%),linear-gradient(to_top,rgba(0,0,0,0.22)_0%,transparent_45%)]"
        aria-hidden
      />

      <div className="relative z-10 mx-auto flex h-full w-full max-w-[1400px] items-center px-4 pb-8 sm:px-10 sm:pb-12 lg:px-16">
        <div className="max-w-[240px] ml-3 mt-6 sm:max-w-[520px] sm:ml-14 sm:mt-14 lg:ml-20 lg:mt-16 lg:max-w-[720px]">
          ...
          >
            <span className="text-[#2997FF]">Architectural</span>
            <br />
            <span className="text-[#2997FF]">Cost</span>
            <br />
          ...
          <p
            ...
            style={{ fontFamily: 'Poppins, sans-serif' }}
          >
            Save time before bid day with precise architectural cost estimating services.
          </p>
        </div>
      </div>
    </section>
