  ...
  return (
    <section className="w-full pt-0 pb-10 lg:pb-12">
      <div className="relative mx-auto w-full overflow-hidden">
        ...
        <div
          className={`${poppins.className} absolute inset-0 z-10 flex flex-col items-center justify-center px-6 text-center sm:px-10`}
        >
          <h2
            className="text-white drop-shadow-[0_2px_8px_rgba(0,0,0,0.75)]"
            style={{
              fontWeight: 600,
              fontSize: '20px',
              lineHeight: '100%',
          ...
          <p
            className="mt-4 max-w-[720px] text-white drop-shadow-[0_2px_8px_rgba(0,0,0,0.75)]"
            style={{
              fontWeight: 100,
              fontSize: '14px',
              lineHeight: '1.5',
