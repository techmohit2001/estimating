...
const PROCESS_STEPS = [
  {
    ...
    description:
      'We review your architectural drawings, specifications, finish schedules, door schedules, window schedules, and project scope.',
  ...
  },
  {
    ...
    description:
      'Our team identifies all architectural items, including walls, flooring, ceilings, doors, windows, finishes, millwork, and interior details.',
  ...
  },
  {
    ...
    description:
      'We measure and count all required materials from the drawings to prepare an accurate architectural quantity takeoff.',
  ...
  },
  {
    ...
    description:
      'We prepare a clear breakdown of material costs, labor costs, finishes, openings, and other architectural scope items.',
  ...
  },
  {
    ...
    description:
      'After quality checking, we deliver a clean architectural cost estimate ready for bidding, budgeting, and project planning.',
  ...
  return (
    <div className="w-full pt-2 pb-8 lg:pt-3 lg:pb-10">
      ...
      >
        ...
        Architectural Estimating Process
        <span
