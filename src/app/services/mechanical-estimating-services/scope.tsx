...
const PROCESS_STEPS = [
  {
    ...
    description:
      'We review your mechanical drawings, specifications, schedules, addenda, and project scope to understand the complete mechanical work.',
  ...
  },
  {
    ...
    description:
      'Our team identifies HVAC systems, ductwork, piping, equipment, insulation, valves, fittings, air devices, and related mechanical items.',
  ...
  },
  {
    ...
    description:
      'We measure and count all required materials, including ducts, pipes, fittings, dampers, diffusers, grilles, equipment, supports, and insulation.',
  ...
  },
  {
    ...
    description:
      'We prepare a clear breakdown of material costs, labor costs, equipment costs, and complete mechanical scope pricing.',
  ...
  },
  {
    ...
    description:
      'After quality checking, we deliver a clean mechanical estimate ready for bidding, budgeting, procurement, and project planning.',
...
export default function Scope() {
  return (
    <div className="w-full pt-2 pb-8 lg:pt-3 lg:pb-10">
      ...
      <p
        className={`${poppins.className} mt-3 max-w-3xl text-[15px] leading-[1.6] text-[#4a4a4a] sm:mt-4 sm:text-[16px] lg:mt-5`}
      >
        We follow a structured process to make sure your estimate is clear,
        organized, and useful for bidding.
      </p>
