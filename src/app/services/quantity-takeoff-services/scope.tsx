...
const PROCESS_STEPS = [
  {
    ...
    description:
      'Send us your drawings, specifications, addenda, and project scope documents. Our team reviews the files to understand the project requirements.',
  ...
  {
    number: 2,
    title: 'Scope & Drawing Review',
    description:
      'We analyze the drawings and scope to identify required quantities, missing information, and areas that may need clarification before takeoff begins.',
  ...
  {
    number: 3,
    title: 'Blueprint Takeoff & Quantity Measurement',
    description:
      'Our estimators prepare detailed quantity takeoffs for materials, labor, and trade-specific items, along with cost estimates based on project requirements.',
  ...
  {
    number: 4,
    title: 'Trade-Wise Quantity Breakdown',
    description:
      'The estimate undergoes an internal review to verify quantities, scope coverage, and overall accuracy before delivery.',
  ...
  {
    number: 5,
    title: 'Final Takeoff Report Delivery',
    description:
      'You receive organized estimate files, including quantity summaries, Excel sheets, and marked-up drawings, ready for bidding, budgeting, and preconstruction planning.',
