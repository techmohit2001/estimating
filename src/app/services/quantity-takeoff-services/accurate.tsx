    ...
    <div className="w-full py-10 lg:py-14">
      <div className="grid grid-cols-1 gap-6">
        <div className="order-1">
          ...
          >
            <p>
              Get detailed quantity takeoff services prepared from your construction drawings,
              blueprints, specifications, and scope documents. We help general contractors,
              subcontractors, builders, developers, architects, engineering firms, and project owners
              measure project quantities clearly before bidding, budgeting, or procurement begins.
              Our material takeoff services help you understand what materials are required, how much
              is needed, and which trade items should be reviewed before pricing. From residential
              buildings to commercial, industrial, and civil projects, our takeoff team prepares
              organized reports that support faster bids, better material planning, and fewer missed
              quantities. A clear construction quantity takeoff gives your team a strong base for
              estimating and purchasing decisions. Instead of relying on rough assumptions, you
              receive measured quantities from drawings with structured reports, marked-up plans, and
              trade-wise material summaries.
            </p>
          </div>
        </div>
